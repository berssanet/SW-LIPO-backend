...
use Allquanto\Datatrans\DatatransApi\Exception\DatatransApiException;
...
class AbstractClient
{
    ...
    private function handleRequestException(RequestException $requestException, array $data): DatatransApiException
    {
        ...
        if ($exceptionResponse === null) {
            ...
            return new DatatransApiException('General Error', $exceptionMessage);
        }
        ...
        if (\array_key_exists('error', $error) && \array_key_exists('error_description', $error)) {
            ...
            return new DatatransApiException($error['error'], $error['error_description'], (int) $requestException->getCode());
        }
        ...
        return new DatatransApiException($error['name'] ?? 'UNCLASSIFIED_ERROR', $message, (int) $requestException->getCode(), $issue);
    }
